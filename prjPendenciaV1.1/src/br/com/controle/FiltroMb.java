   ...
   //Metodo construtor
	...
	public void fecharPendencia(){
		...
		if(!pendencia.getStatusPed().equalsIgnoreCase("Em aberto")){
			...
			System.out.println("Pendência já está em aberto, para fechar selecione fechar!");
			FacesContext context = FacesContext.getCurrentInstance();
			context.addMessage(null, new FacesMessage("Atenção!","Pendência já está em aberto, para fechar selecione fechar!"));
		}
	}
